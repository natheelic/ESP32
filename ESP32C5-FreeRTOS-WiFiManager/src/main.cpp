/*
 * ESP32-C5 — FreeRTOS + WiFiManager Template
 *
 * โครงสร้างพื้นฐานสำหรับ ESP32-C5:
...
void setup() {
  ...
  // Wait for USB CDC (ESP32-C5 native USB)
...
void taskWiFi(void *param) {
  ...
  // ลด TX power สำหรับ Super Mini (เสาอากาศ PCB ตัวเล็ก)
  WiFi.setTxPower(WIFI_POWER_8_5dBm);
  Serial.println("[WiFi] TX power set to 8.5dBm");
